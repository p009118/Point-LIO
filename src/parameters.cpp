...
void readParameters(ros::NodeHandle &nh)
{
  ...
  nh.param<bool>("mapping/point_cov_en", point_cov_en, false);
  nh.param<double>("mapping/point_cov_range_k", point_cov_range_k, 1e-3);
  nh.param<double>("mapping/point_cov_inc_k", point_cov_inc_k, 0.2);
  nh.param<double>("mapping/point_cov_omega_k", point_cov_omega_k, 1e-3);
  ...
  nh.param<int>("mapping/degeneracy_warmup", degeneracy_warmup, 50);
